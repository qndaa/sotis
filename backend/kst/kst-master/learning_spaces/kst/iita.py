...
import numpy as np
from .ind_gen import *
from .ob_counter import *
from .orig_iita import *
from .mini_iita import *
from .corr_iita import *
...
def iita(dataset, v):
    ...
    if (
        not isinstance(dataset, pd.DataFrame) and not isinstance(dataset, np.ndarray)
